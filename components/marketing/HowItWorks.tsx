            ...
            {steps.map((step, index) => (
              <li key={step.number} className="relative">
                ...
                <div className="relative">
                  {/* Icon container */}
                  <div className="mx-auto flex h-16 w-16 items-center justify-center lg:h-20 lg:w-20">
                    <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.bgGradient} ring-1 ring-border/20`} />
                    <div className={`relative text-white`}>
                      <div className={`rounded-full bg-gradient-to-br ${step.gradient} p-3 lg:p-4`}>
                        {step.icon}
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="rounded-3xl border border-border bg-gradient-to-br from-muted/30 to-muted/10 p-8 lg:p-12">
            ...
            <div className="mt-6">
              <a
                href="/coming-soon"
                className="inline-flex items-center gap-2 rounded-2xl bg-primary px-8 py-4 text-base font-semibold text-primary-foreground shadow-lg transition-all duration-200 hover:shadow-xl hover:shadow-primary/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary"
              >
