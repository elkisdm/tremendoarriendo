        ...
        >
            ...
            <div className="text-center">
                <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-bold text-white:text-white">
            ...
            <div className="space-y-4">
                {faqs.map((faq, index) => (
                    <motion.div
                        ...
                        className="bg-gray-800:bg-gray-800 rounded-xl border border-gray-700:border-gray-700 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
                    >
                        <button
                            onClick={() => toggleFAQ(index)}
                            className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-gray-900:hover:bg-gray-700/50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset"
                            aria-expanded={openIndex === index}
                            aria-controls={`faq-answer-${index}`}
                        >
                            <span className="font-semibold text-white:text-white pr-4">
                                {faq.question}
                            </span>
                        ...
                        <AnimatePresence>
                            {openIndex === index && (
                                ...
                                >
                                    <div className="px-6 pb-4 text-gray-300:text-gray-400 leading-relaxed">
                                        {faq.answer}
                                    </div>
                                </motion.div>
                            )}
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a
                        ...
                        className="flex items-center gap-3 p-4 bg-gray-800:bg-gray-700 rounded-xl hover:shadow-md transition-all duration-300 border border-gray-700:border-gray-600 group"
                    >
                        <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 transition-colors">
                            <FileText className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                        </div>
                        <div>
                            <h4 className="font-medium text-white:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    ...
                    >
                        ...
                        <div>
                            <h4 className="font-medium text-white:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                    ...
                    >
                        ...
                        <div>
                            <h4 className="font-medium text-white:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
